...
const Opinions = () => (
    <section className="min-h-96 w-full bg-amber-300 px-4 lg:px-24 py-12">
        <HeaderElement />
        <div className="flex flex-wrap ">
            <div className="lg:w-1/3 pb-6 lg:p-6">
                <p className=" border-4 border-amber-500 p-2 pt-44 pb-24 rounded-t-full text-amber-800 text-2xl text-center whitespace-normal break-words px-6">
